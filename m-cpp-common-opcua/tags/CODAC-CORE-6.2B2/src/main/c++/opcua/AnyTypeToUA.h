/******************************************************************************
* $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-cpp-common-opcua/tags/CODAC-CORE-6.2B2/src/main/c++/opcua/AnyTypeToUA.h $
* $Id: AnyTypeToUA.h 101413 2019-08-07 06:22:48Z bauvirb $
*
...
/**
 * @file AnyTypeToUA.h
 * @brief Header file for AnyTypeToUA helper routines.
 * @date 01/11/2017
 * @author Bertrand Bauvir (IO)
 * @copyright 2010-2017 ITER Organization
 * @detail This header file contains the definition of the AnyTypeToUA helper routines.
 */

#ifndef _AnyTypeToUA_h_
#define _AnyTypeToUA_h_
